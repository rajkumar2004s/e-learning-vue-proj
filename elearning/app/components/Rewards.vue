<template>
  <section class="py-20 bg-gray-50">
    <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-3 gap-10">
      <div
        class="bg-white rounded-xl shadow-md p-8 text-center hover:scale-105 transition"
      >
        <div class="text-4xl text-orange-400 mb-4">🎓</div>
        <h3 class="text-xl font-bold mb-2">Certified Courses</h3>
      ...
      >
        ...
        <p class="text-gray-500">
          Practice projects and real-world scenarios included.
        </p>
      </div>
      <div
        class="bg-white rounded-xl shadow-md p-8 text-center hover:scale-105 transition"
      >
        ...
        <p class="text-gray-500">
          Join learners from 190+ countries and network worldwide.
        </p>
      </div>
    </div>
  </section>
